import unittest
from t_1_2 import hasCycle_2, ListNode
...
class TestCycleList(unittest.TestCase):
    def test_non_cyclic_list(self):
        ...
        node7.next = node8
        node8.next = node3
        self.assertTrue(hasCycle_2(node1), msg="Неверная работа")

    def test_one_element(self):
        """Один элемент"""
        node1 = ListNode(1)
        node1.next = None
        self.assertFalse(hasCycle_2(node1))
    ...
    def test_cyclic_list(self):
        ...
        self.assertTrue(
            hasCycle_2(node1), "Циклический список определен как нециклический"
        )
    ...
    def test_non_cyclic_list(self):
        ...
        node2.next = node3
        self.assertFalse(
            hasCycle_2(node1), "Нециклический список определен как циклический"
        )
